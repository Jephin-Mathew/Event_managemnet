...
new #[Layout('layouts.guest')] class extends Component
{
    ...
    public function login(): void
    {
        ...
        $this->redirectIntended(default: route('events.list', absolute: false), navigate: true);
    }
}; ?>
...
<div>
    ...
    <div class="text-center mt-6">
        ...
        <a href="{{ route('register') }}" class="btn btn-link text-indigo-600 hover:text-indigo-900">
            Register an Account
        </a>
    </div>
</div>
